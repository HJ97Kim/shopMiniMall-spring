...
<form action="MemberAddServlet" method="post">
	*아이디:<input type="text" name="userid" id="userid"> <span
		...
		id="passwd2"> <span id="result2"></span> <br> 이름:<input
		type="text" name="username"><br> <input type="text"
		name="post" id="sample4_postcode" placeholder="우편번호"> <input
	...
	<input type="text" name="addr1" id="sample4_roadAddress"
		...
		id="email1">@ <input type="text" name="email2" id="email2"
		placeholder="직접입력"> <select id="emailSelect">
